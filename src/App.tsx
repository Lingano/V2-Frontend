        ...
        <>
            ...
            <main className="container mx-auto px-4 py-8">
                ...
                <div className="text-center my-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">Welcome to Lingano</h1>
                    <p className="text-xl text-base-content mb-8">The fast, fun and effective way to learn.</p>
                    ...
                    <div className="card bg-secondary text-secondary-content shadow-lg max-w-md mx-auto">
                        <div className="card-body flex md:flex-row items-center">
                            ...
                            <div>
                                ...
                                {currentTime.split("\n").map((line, index) => (
                                    <p key={index} className={index === 0 ? "text-primary text-xl" : "text-sm opacity-75"}>
                                        {line}
                                    </p>
                                ))}
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="card bg-secondary text-secondary-content shadow-lg col-span-2">
                            <div className="card-body">
                                <h3 className="card-title text-primary">Learning Progress</h3>
                        ...
                        <div className="card bg-secondary text-secondary-content shadow-lg">
                            <div className="card-body items-center text-center">
                                <h3 className="card-title text-primary">Total Users</h3>
                                <div className="text-4xl font-bold text-primary mt-4">5,670</div>
                                <div className="text-primary-focus mt-2">Active users</div>
                                <div className="badge badge-primary mt-4 py-3">+15% vs last month</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="card bg-secondary text-secondary-content shadow-lg hover:shadow-xl transition-all">
                            <div className="card-body items-center text-center">
                                <div className="w-16 h-16 rounded-full bg-primary text-primary-content flex items-center justify-center text-2xl mb-4">🔄</div>
                                <h3 className="card-title text-primary">Real-time Updates</h3>
                                <p>Stay updated with the latest information in real-time.</p>
                            </div>
                        </div>
                        ...
                        <div className="card bg-secondary text-secondary-content shadow-lg hover:shadow-xl transition-all">
                            <div className="card-body items-center text-center">
                                ...
                                <p>Our interface adapts perfectly to any device, from mobile phones to large desktops.</p>
                            </div>
                        </div>
                        ...
                        <div className="card bg-secondary text-secondary-content shadow-lg hover:shadow-xl transition-all">
                            <div className="card-body items-center text-center">
                                <div className="w-16 h-16 rounded-full bg-primary text-primary-content flex items-center justify-center text-2xl mb-4">📊</div>
                                <h3 className="card-title text-primary">Advanced Analytics</h3>
                                <p>Track and analyze your data with our powerful analytics dashboard tools.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="min-h-screen bg-base-100">
                ...
                <header className="navbar bg-secondary text-secondary-content sticky top-0 z-50 shadow-md">
                    ...
                    <div className="navbar-center hidden lg:flex">
                        <ul className="menu menu-horizontal px-1">
                            ...
                            <li>
                                <Link to="/rybbit" className="hover:text-primary">Rybbit</Link>
                            </li>
                        </ul>
                    </div>
                ...
                <footer className="footer p-10 bg-secondary text-secondary-content">
                    ...
                    <nav>
                        ...
                        <Link to="/contact" className="link link-hover hover:text-primary">Contact Us</Link>
